    ...
    <main class="main-content kanban-app w-full">
        ...
        <div class="flex h-[calc(100vh-8.5rem)] flex-grow flex-col">
            <div x-init="Sortable.create($el, {
                ...
                class="kanban-scrollbar flex w-full items-start space-x-4 space-x-reverse overflow-x-auto overflow-y-hidden px-[var(--margin-x)] transition-all duration-[.25s]">
