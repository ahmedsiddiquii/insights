            ...
            <div class="flex h-full grow flex-col bg-white pr-[var(--main-sidebar-width)] dark:bg-navy-750">
                ...
                <div class="flex h-18 w-full items-center justify-between pr-4 pl-1">
                    <div class="flex items-center">
                        <div class="avatar ml-3 hidden h-9 w-9 lg:flex">
                            <div
                                ...
                                <ul class="mt-1 space-y-1 px-2 font-inter text-xs+ font-medium">
                                    <li x-data="{ expanded: false }">
                                        <div tabindex="0"
                                            ...
                                            <button @click="expanded = !expanded"
                                                class="btn ml-1 h-5 w-5 rounded-lg p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="ml-3 h-6 w-6 text-warning"
                                        ...
                                        <ul x-show="expanded" x-collapse class="pr-4">
                                            <li>
                                                <div tabindex="0"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="ml-3 h-6 w-6 text-warning" viewBox="0 0 20 20"
                                                        fill="currentColor">
                                                        <path
                                                            d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
                                                    </svg>
