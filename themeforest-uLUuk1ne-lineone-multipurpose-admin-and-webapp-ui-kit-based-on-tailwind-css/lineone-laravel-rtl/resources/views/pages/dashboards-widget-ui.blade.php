            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                    ...
                    <div class="my-3 flex h-8 items-center justify-between">
                        ...
                        <div x-data="usePopper({ placement: 'bottom-start', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                            ...
                            <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                class="btn -ml-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                ...
                <div class="card p-4">
                    <div class="flex -space-x-px space-x-reverse">
                        ...
                        <button
                            class="btn z-2 h-10 w-10 shrink-0 rounded-r-none bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                ...
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="mt-4 grid grid-cols-4 gap-3">
                        <div class="text-center">
                            <div class="avatar h-10 w-10">
                                <img class="rounded-full" src="{{ asset('200x200.jpg') }}"
                                    alt="avatar" />
                            </div>
