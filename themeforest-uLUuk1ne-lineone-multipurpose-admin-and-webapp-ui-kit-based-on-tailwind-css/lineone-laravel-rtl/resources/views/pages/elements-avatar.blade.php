            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="inline-space mt-5 flex flex-wrap">
                        <div class="flex h-16 w-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                        ...
                        <div class="flex h-16 w-16 rounded-full bg-gradient-to-r from-amber-400 to-orange-600 p-0.5">
                            <div class="avatar h-full w-full rounded-full bg-white p-[3px] dark:bg-navy-700">
                                <img class="rounded-full" src="{{ asset('images/200x200.png') }}"
                                    alt="avatar" />
                            </div>
                        ...
                        <div class="flex h-16 w-16 rounded-full bg-gradient-to-r from-pink-500 to-rose-500 p-0.5">
                            <div class="avatar h-full w-full rounded-full bg-white p-[3px] dark:bg-navy-700">
                                <img class="rounded-full" src="{{ asset('images/200x200.png') }}"
                                    alt="avatar" />
                            </div>
                        ...
                        <div class="flex h-16 w-16 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
                            <div class="avatar h-full w-full rounded-full bg-white p-[3px] dark:bg-navy-700">
                                <img class="rounded-full" src="{{ asset('images/200x200.png') }}"
                                    alt="avatar" />
                                <div
                        ...
                        <div class="flex h-16 w-16 rounded-full bg-gradient-to-r from-green-400 to-fuchsia-400 p-0.5">
                            <div class="avatar h-full w-full rounded-full bg-white p-[3px] dark:bg-navy-700">
                                <img class="rounded-full" src="{{ asset('images/200x200.png') }}"
                                    alt="avatar" />
                            </div>
